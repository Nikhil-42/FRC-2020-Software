...
{  
    ...
    public static final double OutputRampRate = 0.1;
    public static final double OutputFilter = 0.1;
    ...
    public static final int headdingAverageNumberOfSamples = 10;  // smothing for heading angle changes.
